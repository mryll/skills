...
- **ste** — Ask to "reescribí esto en STE", "rewrite this in Simplified Technical English", "redactá este warning en STE", or "check this against ASD-STE100". Output is dictionary-verified STE English, with a translation on request.
