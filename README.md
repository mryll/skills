...
- **ste** — Ask to "reescribí esto en STE", "explicame esto en STE", "rewrite this in Simplified Technical English", "redactá este warning en STE", or "check this against ASD-STE100" — works mid-conversation on anything just discussed. Choose Verified (dictionary-checked), Marked, or Clean; translation on request.
